    ...
    public static class RouteHelpers
    {
        ...
        public static Route ToRoute(this RouteHandler handler)
        {
            return
                context =>
                {
                    var task = (Task<RouteHandlerResult>) handler(context.Parameters);
                    return task.ToObservable().Select(handlerResult =>
                    {
                        return handlerResult.ToRouteResult(context.Unmatched);
                    });
                };
        }
    }
