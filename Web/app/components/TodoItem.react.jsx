...
export default class TodoItem extends React.Component {
    ...
    render() {
        ...
        if (this.state.isEditing) {
            input =
                <TodoTextInput className="edit" onSave={this._onSave.bind(this)} value={this.state.name}/>;
        }
        ...
        <div className="view">
          <input className="toggle" type="checkbox" checked={this.state.done} onChange={this._onToggleComplete.bind(this)}/>
...
TodoItem.propTypes = {
    todosid: React.PropTypes.number.isRequired,
